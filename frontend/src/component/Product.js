...
const Product = () => {
    ...
    const showProducts = async()=>{
        let result = await fetch("https://mern-pharmacy.vercel.app/stock")
    ...
    const deleteProduct = async(id)=>{
      let result = await fetch(`https://mern-pharmacy.vercel.app/delete/${id}`,{
        method:"Delete"
      })
      let responce = await result.json()
      console.log(responce)
    ...
    const handleSearch = async (e)=>{
      ...
      if(key)
          {
            let result = await fetch(`https://mern-pharmacy.vercel.app/search/${key}`)
